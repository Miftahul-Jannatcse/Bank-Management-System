...
if (isset($_POST['transfer'])){
  ...
  if($rs1){
    ...
    if ($connected){
      $msg="Hello dear ".$name."! You have withdraw balance from your SKY BANK account  on ".$tms1.". Amount ".$newbnc.".00BDT withdraw successfully. Your remaining account balance is ".$bnc1.".00BDT. Thank you for joining SKY BANK service.";
                  ...
                  if(mysqli_num_rows($nm)>0){
                    ...
                    <div class="row">
                        ...
                        <div  class="col-sm-6">
                            ...
                            <input type="text" class="form-control" name="blnc" value="<?php echo $row['balance'].".00 BDT";?>"  readonly>
                        </div>
                    </div>
                    <hr style="height:1px;border-width:0; width: 100%; margin-bottom:  -5px; margin-top: 20px; color:red;background-color:gray;">
                    <br>
