...
if (isset($_POST['transfer'])){
  ...
  if($rs1){
    ...
    if ($connected){
      $msg="Hello dear ".$name."! You have deposit balance in your SKY BANK account  on ".$tms1.". Amount ".$newbnc.".00BDT deposit successfully. Your current account balance is ".$bnc1.".00BDT. Thank you for joining SKY BANK service.";
