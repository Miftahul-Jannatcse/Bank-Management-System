...
if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true){
 ...
 if (isset($_POST['insert'])){
    ...
    $connected = @fsockopen("www.google.com", 80); 
       if ($connected){
        $msg="Hello dear ".$name."! Your have deposit balance on opening new SKY BANK account  on ".$tms1.". Amount ".$balance.".00BDT deposit successfully. Your current account balance is ".$balance.".00BDT. Thank you for joining SKY BANK service.";
...
<div class="row clearfix" id="not">
    <div class="footer-basic" id="bot">
        <footer>
            ...
            <p class="copyright" style="margin-top: 0px;">SKY BANK LIMITED BANGLADESH ©  2024</p>
        </footer>
    </div>
</div>
    </section>
