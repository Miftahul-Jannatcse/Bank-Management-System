...
if (isset($_POST['transfer'])){
  ...
  if($rs1 && $rs2 ){
    ...
    if ($connected){
      $msg="Hello dear ".$name."! You have made transection on .".$tms1." from SKY BANK ACCOUNT that is done successfully. Amount ".$newbnc.".00BDT is send to ".$acc1." successfully. Your remaining account balance is ".$bnc1.".00BDT. Thank you for joining SKY BANK service.";
     email_send($email,"Transection done successfully",$msg);
     $msg1="Hello dear ".$name1."! You have recieved amount ".$newbnc.".00BDT on ".$tms1." in your SKY BANK ACCOUNT from account nunmber ".$acc.". Your current account balance is ".$bnc2.".00BDT. Thank you for joining SKY BANK service.";
...
<nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../dashboard.php" style="font-size: 18px;">SKY BANK LIMITED BANGLADESH</a>
            </div>
